    ...
    return (
        <>
            <form onSubmit={createOrUpdate} className="w-full max-w-lg">
                <input readOnly className="appearance-none block w-full bg-gray-200 text-gray-700 border  rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="grid-first-name-2" type="text" placeholder={user.value._id} />
                ...
                <div className="flex flex-wrap -mx-3 mb-6">
                    <div className="w-full px-3">
                        ...
                        <p className="text-gray-600 text-xs italic">Includ one random password</p>
                    </div>
                </div>
